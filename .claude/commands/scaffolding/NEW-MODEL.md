---
description: create sqlalchemy model with migration and tests
allowed-tools: Read, Glob, Grep, Write, Bash(alembic:*), Bash(pytest:*)
argument-hint: required: model_name table_name fields
---
