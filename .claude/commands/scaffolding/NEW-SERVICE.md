---
description: create service module with business logic, tests, and type hints
allowed-tools: Read, Glob, Write, Bash(pytest:*), Bash(mypy:*)
argument-hint: required: service_name description
---
