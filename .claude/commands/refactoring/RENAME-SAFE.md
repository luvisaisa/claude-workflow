---
description: safely rename symbol across codebase with verification
allowed-tools: Grep, Glob, Edit, Bash(pytest:*), Bash(mypy:*)
argument-hint: required: old_name new_name
---
