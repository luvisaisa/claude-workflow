---
description: extract code into reusable function/class, update all usages
allowed-tools: Read, Grep, Glob, Edit, Write, Bash(pytest:*), Bash(mypy:*)
argument-hint: required: source_path extraction_target
---
